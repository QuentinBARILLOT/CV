...
exp_oth <- tribble(
    ~title, ~unit, ~startMonth, ~startYear, ~endMonth, ~endYear, ~where, ~detail,
    "Aide médicaux psychologique", "FAM de la Lendemaine", "Mai", 2019, "Juillet", 2019, "Les Molières", "Aide médicaux psychologique pour personnes adultes atteintes de troubles du spectre autistique",
    "Aide médicaux psychologique", "FAM de la Lendemaine", "Mai", 2019, "Juillet", 2019, "Les Molières", "Prise en charge des résidents dans les activités et dans leurs routines."
)
...
ens <- tribble(
    ...
    "Formateur école d'ambulancier", "Croix-Rouge Française", "14H", "2022-2023", "Enseignement sur le module communication de la formation d'ambulancier"
)
...
membership <- tribble(
    ...
    "AFTCC", "Membre de l'association française de thérapie cognitive et comportementale", "2023-2024", 
    "APS", "Membre de l'association for psychological science", "2022-2023",
    "Contrat doctorale", "Obention d'une allocation pour un contrat doctorale", "2021-2024"
)
